...
public class GoalCheckpoint : MonoBehaviour
{
    ...
    private int player1GoalDetector; //Es un contador. El coche pasa dos veces por meta, en la salida y en la llegada. Se guardará el tiempo la segunda vez.
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (player1GoalDetector == 2 && !recordSaved) //Si el coche pasa una segunda vez por la meta guarda el tiempo
        {
            recordSaved = true;
